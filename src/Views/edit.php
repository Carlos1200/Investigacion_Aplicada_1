    ...
    <form action="<?php $_SERVER['REQUEST_METHOD'] ?>" method="post" class="bg-neutral-800 w-1/2 mx-auto p-5 rounded-lg">
        <div class="w-full">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="border py-2 px-3 text-grey-darkest" type="text" name="first_name" value="<?php echo $users['first_name'] ?>">
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 uppercase font-bold text-lg text-white">Apellido</label>
                <input class="border py-2 px-3 text-grey-darkest" type="text" name="last_name" value="<?php echo $users['last_name'] ?>">
            </div>
            <div class="flex flex-col mb-4">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input class="border py-2 px-3 text-grey-darkest" type="text" name="gender" value="<?php echo $users['gender'] ?>">
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 uppercase font-bold text-lg text-white">Ciudad</label>
                <input class="border py-2 px-3 text-grey-darkest" type="text" name="city" value="<?php echo $users['city'] ?>">
            </div>
